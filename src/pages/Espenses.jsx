    ...
    <main className="expenses-page">
                ...
                {expenses.length ? (
                  expenses.map(expense => (
                    <tr key={expense.slug}>
                      ...
                      <td>
                        <button className="btnStyle" onClick={() => openEditModal(expense)}>
                          <FaPencilAlt />
                        </button>

                        <button className="btnDelete" onClick={() => handleDelete(expense.slug)}>
                          <FaTrashAlt />
                        </button>
                      </td>
                    </tr>
      ...
      {modalOpen && (
        <div className="budget-modal">
          <div className="budget-modal-content improved-modal">
